        ...
        <div className='flex flex-col md:flex-row gap-8'>
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <span>on</span>
                    <Link className="text-blue-800" to={`/posts?cat=${posts[0].category}`} >{posts[0].category}</Link>
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-6">
                ...
                {posts[1] && <div className="md:h-1/3 flex justify-between gap-4">
                    ...
                    <div className="w-2/3 flex flex-col">
                        <div className="flex items-center gap-2 text-[9px] sm:text-xs md:text-[9px] lg:text-sm 2xl:text-md lg:mb-2">
                            <h1 className="font-medium">02.&nbsp;<Link className="text-blue-800 font-medium" to={`/posts?author=${posts[1].user.username}`}>{posts[1].user?.username}</Link></h1>
                            <span>on</span>
                            <Link className="text-blue-800" to={`/posts?cat=${posts[1].category}`}>{posts[1].category}</Link>
                ...
                {posts[2] && <div className="md:h-1/3 flex justify-between gap-4">
                    ...
                    <div className="w-2/3 flex flex-col">
                        <div className="flex items-center gap-2 text-[9px] sm:text-xs md:text-[9px] lg:text-sm 2xl:text-md lg:mb-2">
                            <h1 className="font-medium">03.&nbsp;<Link className="text-blue-800 font-medium" to={`/posts?author=${posts[2].user.username}`}>{posts[2].user?.username}</Link></h1>
                            <span>on</span>
                            <Link className="text-blue-800" to={`/posts?cat=${posts[2].category}`}>{posts[2].category}</Link>
                ...
                {posts[3] && <div className="md:h-1/3 flex justify-between gap-4">
                    ...
                    <div className="w-2/3 flex flex-col">
                        <div className="flex items-center gap-2 text-[9px] sm:text-xs md:text-[9px] lg:text-sm 2xl:text-md lg:mb-2">
                            <h1 className="font-medium">04.&nbsp;<Link className="text-blue-800 font-medium" to={`/posts?author=${posts[3].user.username}`}>{posts[3].user?.username}</Link></h1>
                            <span>on</span>
                            <Link className="text-blue-800" to={`/posts?cat=${posts[3].category}`}>{posts[3].category}</Link>
